...
{
    public sealed class GetActiveSet : ClientMessage
    {
        private static readonly log4net.ILog log =
		    log4net.LogManager.GetLogger( typeof( GetActiveSet ) );
                ...
                ClientAdapterRequest.CreateBuilder()
                    ...
                    .SetDealingRequest(
                       DealingEngineRequest.CreateBuilder()
                           .SetRequestId( request_id )
                           .SetTimestamp( timestamp )
                           .SetType( DealingEngineRequest.Types.RequestType.ACTIVE_SET ) )
                .Build();
        }
    }
}