...
{
    public sealed class ReloadStaticData : ClientMessage
    {
        private static readonly log4net.ILog log =
		    log4net.LogManager.GetLogger( typeof( ReloadStaticData ) );

        public ReloadStaticData( )
        { }
                ...
                ClientAdapterRequest.CreateBuilder()
                    ...
                    .SetDealingRequest(
                       DealingEngineRequest.CreateBuilder()
                           .SetRequestId( request_id )
                           .SetTimestamp( timestamp )
                           .SetType( DealingEngineRequest.Types.RequestType.RELOAD_STATIC_DATA ) )
                .Build();
        }
    }
}
